...
from vector_pipeline import process_and_store_embeddings
...
def main():
    ...
    # Step 3: Filter keys and structure output
    formatted_output = [
        {
            "page_index": page["page_index"],
            "page_number": page["page_number"],
    ...
    # Step 4: Vectorize and store in Qdrant database
    process_and_store_embeddings(formatted_output, pdf_path)
