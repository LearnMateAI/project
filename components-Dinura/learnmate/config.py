...
The two settings that matter most:
    ...
    LEARNMATE_GENERATOR_BACKEND   "llamacpp" (in-process GGUF) or "http" (served model)
    LEARNMATE_GENERATOR_MODEL     path to the GGUF, or the model name for the HTTP backend
...
# components-Dinura/.env holds HF_TOKEN and any override below.
