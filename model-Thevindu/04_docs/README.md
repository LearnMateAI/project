...
| Document | Purpose |
|----------|---------|
| `FULL_WORKFLOW_AND_BRANCH_INVENTORY.md` | Step 0→end, git vs gitignore, Qwen eval, future work (evaluators start here) |
| `model_card.md` | Intended use, data, eval, limitations, ethics, degradation |
